...
//console.log(Position)
  return (
    ...
    name={isSecureEntry ? "eye-slash":"eye"} color="black" size={25} />
    </View>
    ...
    <Icon style={{marginHorizontal:50}} name="arrow-right" color="white" size={15}/>
    </Pressable>
    <Pressable
    style={({ pressed }) => [{ 
    opacity: pressed ? 0.7 : 1.0 }, styles.Btn1Style]}
    ...
    <Text style={styles.LoginBtntxt}>RegEmp</Text>
    <Icon style={{marginHorizontal:50}} name="arrow-right" color="white" size={15}/>
    </Pressable>
    </View>
  );
