...
const JobDesc = () => {
  const[Form,SetForm] = useState({
    ...
    <Picker
      ...
      selectedValue = {Role} onValueChange = {setRole} placeholder="React" mode="dropDown">
    ...
    <Picker
      style={{alignItems:'center',width :'100%',backgroundColor:"white",color:"black"}}
      selectedValue = {Year} onValueChange = {setYear} placeholder="1-5" mode="dropDown">
    ...
    <Picker
      style={{alignItems:'center',width :'100%',backgroundColor:"white",color:"black"}}
      selectedValue = {Skill} onValueChange = {setSkill} placeholder="React" mode="dropDown">
            <Picker.Item label = "React" value = "react" />
            <Picker.Item label = "Native" value = "native" />
            <Picker.Item label = "Springboot" value = "spring" />
            <Picker.Item label = "AWS" value = "aws" />
  ...
  <Picker
    style={{alignItems:'center',width :'100%',backgroundColor:"white",color:"black"}}
    selectedValue = {Location} onValueChange = {setLocation} placeholder="tamilnadu" mode="dropDown">
...
<CustomInput
  ...
  <Picker
  style={{alignItems:'center',width :'100%',backgroundColor:"white",color:"black"}}
  selectedValue = {Role1} onValueChange = {setRole1} placeholder="Role" mode="dropDown">
          <Picker.Item label = "React" value = "react" />
          <Picker.Item label = "Native" value = "native" />
          <Picker.Item label = "Springboot" value = "spring" />
          <Picker.Item label = "AWS" value = "aws" />
